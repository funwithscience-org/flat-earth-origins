...
4. AND THE FIRMAMENT IS A PHYSICAL MEDIUM, WHICH IS THE KEY TO THE REFUTATION. p. 5: it "is
   ...
   Appendix E derives the rotating-frame accelerations (eq. 11) and stops there — a
   stress-energy tensor and a cosmological solution are not in that appendix.
...
"R11": dict(
    ...
    tldr=("Item 293 says no observation can decide between the frames — and then it is filed "
          ...
          "published in 1978, which got tested (by Ellis among others), and whose "
          "Earth-near-centre versions were in severe tension with the data by 2011. Bouw's own "
...
<p><strong>The chapter-1 version carries two more hedges, and they are the ones that vanish.</strong> At p. 4 the proposition is <em>other people&rsquo;s</em> and is granted only in part: &ldquo;The more subtle physicists &hellip; will claim, <em>with some justification</em>, that we can neither prove nor disprove the geocentric universe; but that we <em>likewise</em> can neither prove nor disprove the non-geocentric universe either.&rdquo; Attributed, part-granted, and explicitly two-way. Bouw does not rest there &mdash; the same page tells the reader that &ldquo;the geocentric evidence is overwhelming&rdquo; &mdash; which is the tension this entry is about, not a hedge we can hide behind.</p>
<p><strong>Where item 310 comes from, and it is a real citation.</strong> Bouw&rsquo;s chapter&nbsp;36 note&nbsp;2 reads &ldquo;Ellis, G. F. R., 1978. <em>General Relativity and Gravitation</em>, 9:87. Quote is from page 92&rdquo;, and the paper is exactly what he says it is: George Ellis, co-author of <em>The Large Scale Structure of Space-Time</em>, showing that spherically symmetric static spacetimes &ldquo;can reproduce the same cosmological observations as the currently favored Friedmann-Robertson-Walker universes &hellip; provided that the universe is inhomogeneous and our galaxy is situated close to one of its centers.&rdquo; Nothing in that chain is invented. What the chain drops is Ellis&rsquo;s next sentence, which lists the routes out &mdash; and which the field then took.</p>
...
<p><strong>Verdict: self-contradicted.</strong> Not because the underlying physics is wrong &mdash; the frame half is trivially right and the cosmology half was a legitimate open question in 1978 &mdash; but because the three items cannot be held together with the rest of the document, or with each other, or with their own source. A claim that no observation discriminates, filed as an observation-based proof; a claim that the equations are identical, filed beside forty items claiming that the experiments came out one way; and a construction whose author specified the tests, ran one of them, and reported that the models it supports are in trouble.</p>""",
    ...
    advocate=dict(
        ...
        preemptive=(
            ...
            "derives the rotating-frame accelerations and stops; a stress-energy tensor and a "
            "cosmological solution are not in that appendix, so there is no fit to run. That "
            "is a statement about what the appendix contains, and it must stay one. (b) THE "
    ...
    straw_man=dict(
        ...
        detail=("Two misrepresentations of the other side travel with this argument in the source. "
                ...
                "the earth moving around the sun\" (ch. 1, pp. 4-5). Special relativity was "
                ...
                "No physicist since 1905 has held that. The claims actually made are that the "
    ...
    compression=dict(
        ...
        source_wording=("“the physics of the geocentric universe accounts perfectly for what we see "
                        ...
                        "“The more subtle physicists … will claim, <em>with some justification</em>, "
        ...
        note=("The wording barely moves and the <em>speech act</em> moves completely, which is the "
              ...
              "acting on it. <strong>The refutation above answers the source, not the fragment:</strong> "
              "it concedes the frame point outright, concedes that a reputable inhomogeneous "
              "cosmology was published and never retracted, quotes the caveat that the void-model "
    ...
    sources=[
        dict(label="Bouw, Geocentricity: Christianity in the Woodshed (2013 edition of "
                   ...
                   "Appendix E conclusion p. 747, the ch. 1 statements pp. 3–5, Sagnac and "
                   "the firmament's rotation p. 523, oblateness p. 425, Ellis at pp. 538–539, "
                   "the Milky-Way concession p. 555",
