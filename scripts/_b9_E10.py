...
Counts across (A)-(D), case-insensitive, whole-file:
  ...
  "interplanetary" 22 in (B). Enumerated one at a time, because the first pass
                   mischaracterised them: 6 are Maxwell (and Newton) on the aether;
                   11 are the JPL probe-navigation equations and the Shapiro/Wallace
                   dispute over the 1961 Venus radar contact; 1 is a general remark
                   that space probes reach their charted destinations; 1 is Galileo
                   removing comets from interplanetary space in The Assayer; 1 is the
                   Mercury perihelion residual; 2 are the Pioneer anomaly. Dust DOES
                   appear, exactly once, in that last group — "a gravitational
                   frequency shift of Pioneer signals proportional to distance and the
                   density of the interplanetary dust cannot be responsible for the
                   anomaly" — i.e. raised and dismissed as a cause of the Pioneer
                   anomaly. Nothing in the 22 argues from zodiacal-cloud or Kuiper-belt
                   structure, which is what the no_source conclusion rests on.
