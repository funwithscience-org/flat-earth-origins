...
def tab_claims():
    ...
    out = ['<h1>Claims Reviewed</h1>',
           ...
           f'words, a steelman, the refutation, and the best defence the other side still has. '
           f'The rest sit at cluster depth pending writeup.</p>',
